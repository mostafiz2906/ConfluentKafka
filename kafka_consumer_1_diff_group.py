...
def main(topic):
    ...
    count_kafka_consumer1_diff_group = 0
    ...
    while True:
        try:
            ...
            if order is not None:
                ...
                count_kafka_consumer1_diff_group += 1
        except KeyboardInterrupt:
            break

    consumer.close()
    print("Total Consumed by different group consumer1 : " + str(count_kafka_consumer1_diff_group))
